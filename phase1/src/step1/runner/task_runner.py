...
from phase1.src.step1.config import STEP1_BEAM_SIZE, STEP1_TRAIN_TASKS
from phase1.src.step1.data.models import Alignment, ArcTask, Attribution, CandidateConstraint, CandidateTransform, Grid, Hypothesis, SearchStats, to_jsonable
from phase1.src.step1.layer1.perception import perceive_grid
from phase1.src.step1.layer2.alignment import align_objects
from phase1.src.step1.layer2.constraints import extract_constraints
from phase1.src.step1.layer2.sketches import build_candidate_set, generate_candidate_transforms
from phase1.src.step1.layer3.hypothesis import assemble_hypotheses
from phase1.src.step1.layer3.selector import apply_hypothesis_beam, clear_rendered_train_outputs, hypothesis_cache_key, select_best_hypothesis, set_rendered_train_outputs
from phase1.src.step1.layer4.dsl import Step1Program, parse_program, render_program
from phase1.src.step1.layer4.executor import execute_program
from phase1.src.step1.layer5.attribution import build_attribution
from phase1.src.step1.layer5.verify import classify_failure, pixel_accuracy, verify_constraints
from phase1.src.step1.utils.debug_dump import dump_task_debug_bundle
from phase1.src.step1.utils.ids import make_alignment_family_id, make_family_constraint_id, make_family_transform_id
from phase1.src.step1.utils.timing import timed_section


def run_task(task: ArcTask, output_dir: str | Path) -> Attribution:
    allowed_ids = {task_id for _, task_id, _ in STEP1_TRAIN_TASKS}
    if task.task_id not in allowed_ids:
        raise ValueError(f"Diagnostic or unknown task is not allowed in Step 1 runner: {task.task_id}")
    ...
    with timed_section(metrics, "layer3_time_ms"):
        ...
        evaluated_hypotheses, beam_saturated = apply_hypothesis_beam(hypotheses, STEP1_BEAM_SIZE)
