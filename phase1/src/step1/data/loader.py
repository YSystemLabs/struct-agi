...
from phase1.src.step1.config import STEP1_TRAIN_TASKS
from phase1.src.step1.data.models import ArcTask, ExamplePair, Grid
...
def load_step1_train_tasks() -> list[ArcTask]:
    return [load_task(concept, task_id, file_path) for concept, task_id, file_path in STEP1_TRAIN_TASKS]


def load_step1_task_ids() -> list[str]:
    return [task_id for _, task_id, _ in STEP1_TRAIN_TASKS]
