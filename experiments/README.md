...
- [softWTA_softHebb_minimal_validation](softWTA_softHebb_minimal_validation/SoftWTA%20关系原型发现最小验证实验.md) 记录并行自动对象发现路线的分层最小验证草案；当前仍属于工作中探索文档，不是冻结实验包，也没有 canonical report/manifest 要求。
